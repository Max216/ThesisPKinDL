...
<head>
  ...
  <script src="/statis/bootstrap.min.js"></script>
  <script src="/static/alignment.js"></script>
  <script type="text/javascript" src="/static/plotly.1.31.2.min.js"></script>
</head>
				...
				<div class="row">
						...
						<form id='form_general'>	
							<div class='row'>
								...
								<div class="form-check col-sm-4">
									...
									<label for='cb_uncolor_center' class='for-check-label'>Don't color dimensions at zero</label> 
								</div>
								<div class="form-group col-sm-4">
									<label for='zero-threshold'>Zero-Threshold</label>
									<input id='zero-threshold' type="text" name="zero-threshold" class='form-control' placeholder="e.g. 0.1">
								</div>
							</div>
						</form>
						<div class="row">
					...
					<div class="col-sm-6" style="padding-left: 1.5em;">
						<form id='form_general_sample'>
							...
							<div class="form-group">
								<label for='zero-threshold-sample'>Zero-Threshold</label>
								<input id='zero-threshold-sample' type="text" name="zero-threshold" class='form-control' placeholder="e.g. 0.1" value=0.05>
							</div>
							<div class="row">
								<div class="col-sm-4">
