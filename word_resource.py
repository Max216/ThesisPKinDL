...
class WordResource:
	...
	def __init__(self, res_path, build_fn=self.buid_from_snli_format, interested_relations=['contradiction', 'entailment']):
		'''
		...
		self.resource_dict = build_fn(res_path)


	def build_from_snli_format(self, path, relations):
		'''
