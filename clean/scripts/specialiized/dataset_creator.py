...
def test_out():
    ...
    words = 'absence,presence,accurate,inaccurate,advantage,disadvantage,approval,disapproval,approve,disapprove,approves,disppproves,approving,disapprovingadmit,deny,admits,denies,admitting,denying,artificial,natural,arrival,departure,ascend,descent,ascends,descends,ascending,descending,attack,defense,defend,attacks,defends,attacking,defending,attractive,repulsive,backward,forward,beginning,ending,below,above,blunt,sharp,better,worse,bravery,cowardice,bold,timid,capable,incapable,captivity,freedom,discourage,encourage,discouraging,encouraging,discourages,encourages,early,late,foolish,wise,frequent,seldom,fresh,stale,gather,distribute,gathers,distributes,gathered,distributed,guilty,innocent,inside,outside,likely,unlikely,mad,sane,magnetize,demagnetize,please,displease,pleases,displeases,pleased,displeased,sense,nonsense,simple,complicated'.split(',')
