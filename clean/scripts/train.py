...
def main():
    ...
    Usage:
        ...
        train.py multitask <multitask_type> <multitask_data> [--embeddings=<embedding_path>] [--load=<model_path>] [--tdata=<train_data>] [--s1=<sent1_dim>] [--s2=<sent2_dim>] [--s3=<sent3_dim>] [--mlpsent=<mlpsent>]
    """)
    ...
    if args['new']:
        ...
        if load_path == None:
            ...
            mlp_sent_dict['mt_both_mlpsent_1200_d'] = 1200
